		...
		<div id="site-bottom" class="clear">
			...
			<div class="site-info">
				...
				<?php 
						...
						$author_uri = 'https://www.freshthemes.com/themes/newsnow';
				?>

				&copy; <?php echo date("o"); ?> <a href="<?php echo home_url(); ?>"><?php echo get_bloginfo('name'); ?></a> - <a href="<?php echo $author_uri; ?>" target="_blank">Upgrade to PRO version</a>
